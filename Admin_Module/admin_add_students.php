...
<?php include 'admin_header_student.php';?>
...
<?php if(isset($_REQUEST['success'])){?>
	...
	<table id="tblstudent"class="addStudentstable">
		...
		<tr>
			...
			<td><a class="dltBtn" href="admin_delete_student_post.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
		</tr>
		<?php
			$i++;
			}
...
<form class="adduserform" method="POST" action="admin_add_student_post.php">
