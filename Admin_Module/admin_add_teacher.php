...
$qr = mysqli_query($conn,"SELECT * FROM users WHERE user_type='1'"); //usertype 2 is student

?>

<?php include 'admin_header_teacher.php';?>
...
<?php if(isset($_REQUEST['success'])){?>
	...
	<table id="tblteacher" class="addStudentstable">
		<tr>
		...
		<tr>
			...
			<td><a class="dltBtn" href="admin_delete_teacher_post.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
		</tr>
		<?php 
			$i++;
			}
...
<form class="adduserform" method="POST" action="admin_add_teacher_post.php">
...
var tblteacher = document.getElementById('tblteacher');
//var rIndex;

for(var i=1; i < tblteacher.rows.length; i++)
{
	tblteacher.rows[i].onclick = function()
	{
